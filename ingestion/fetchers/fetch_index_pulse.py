...
if __name__ == "__main__":
    ...
    if "--discover" in sys.argv:
        ...
        discover_pulse_tickers(
            ...
            output_file=pulse_dir / "euro_stoxx_10_tickers.json"
        )
        discover_pulse_tickers(
            reg_file=stage_dir / "stoxx_usa_50.json",
            output_file=pulse_dir / "stoxx_usa_10_tickers.json"
        )
    else:
        # Run every minute: fetches pulse for the pre-discovered 20 tickers
        fetch_pulse(
            ticker_file=pulse_dir / "euro_stoxx_10_tickers.json",
            output_file=pulse_dir / "euro_stoxx_10_pulse.json",
            index_name="EURO STOXX 10"
        )
        fetch_pulse(
            ticker_file=pulse_dir / "stoxx_usa_10_tickers.json",
            output_file=pulse_dir / "stoxx_usa_10_pulse.json",
