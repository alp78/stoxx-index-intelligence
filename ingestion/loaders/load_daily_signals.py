"""Loads daily signals JSON into bronze.daily_signals. Strategy: append."""
...
def load(json_file, index_name):
    ...
    for rec in records:
        ...
        cursor.execute("""
            INSERT INTO bronze.daily_signals (
...
if __name__ == "__main__":
    ...
    load(signals_dir / "euro_stoxx_50_daily_signals.json", "euro_stoxx")
    load(signals_dir / "stoxx_usa_50_daily_signals.json", "stoxx_usa")
